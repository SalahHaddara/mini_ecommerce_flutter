      ...
      body: SafeArea(
        child: Consumer<OrderProvider>(
          builder: (context, orderProvider, child) {
            ...
            if (orderProvider.error != null && orderProvider.allOrders.isEmpty) {
              return ErrorDisplay(
                message: orderProvider.error!,
                onRetry: () => orderProvider.loadAllOrders(),
              );
            }
  ...
  void _showOrderDetails(BuildContext context, Order order) {
    showModalBottomSheet(
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        maxChildSize: 0.9,
        minChildSize: 0.5,
        builder: (context, scrollController) => _AdminOrderDetailsSheet(
          order: order,
...
class _AdminOrderDetailsSheet extends StatelessWidget {
  final Order order;
  final ScrollController scrollController;

  const _AdminOrderDetailsSheet({
    required this.order,
